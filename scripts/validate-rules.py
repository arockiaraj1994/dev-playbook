#!/usr/bin/env python3
"""
validate-rules.py - Pre-commit / CI gate for the standards corpus.
...
from corpus import standards_spec  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    all_errors: list[_Error] = _validate_standards(check=args.check, regen=args.regen_index)
